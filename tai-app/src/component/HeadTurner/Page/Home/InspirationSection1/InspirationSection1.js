        ...
        <section className="inspiration-section">
            <div className="inspiration-left">
                <div className="info">
                    ...
                    <p className="description">Head Turner cung cấp những sản phẩm tốt nhất dành cho nam giới.</p>
                    <button className="see-more-btn">XEM THÊM</button>
                </div>
            </div>
            <div className="inspiration-right">
                <img src="https://theme.hstatic.net/200000893323/1001256440/14/home_about_banner_3.jpg?v=1595" alt="Barbershop" />
            </div>
        </section>
    );
};
